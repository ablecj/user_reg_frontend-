    ...
    <div className='Aadhar_container'>
        <div className='Aadhar_cont'>
            ...
            <div className='Aadhar_input_container'>
                <input type="text" className='Aadhar_input' placeholder='Enter the Aadhar Number'  name="Aadhar"  pattern="\d{12}" required onChange={handleChangeAdhar} />
            ...
            {
              isVerified? (<span className='aadhar_verify_success'>Aadhar verified successfully</span>) : (<span className='aadhar_verify_failed'>Aadhar verification failed</span>)
            }
            {
              isVerified && <button className='Aadhar_next_btn' onClick={handleNextBtn}>Next</button>
            }
