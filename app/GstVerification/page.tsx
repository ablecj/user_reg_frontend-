    ...
    <div className="gst_container">
      <div className="gst_verify_cont">
        ...
        {verificationResult !== null &&
          (verificationResult ? (
            <span className="gst_success">GST verified successfully</span>
          ) : (
            <span className="gst_failed">GST verification failed</span>
          ))}

        {verificationResult && (
          <button className="gst_next_btn" onClick={handleNextBtn}>
            Next
          </button>
        )}
      </div>
