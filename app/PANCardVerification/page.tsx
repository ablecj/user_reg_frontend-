    ...
    <div className="Pan_card_verification">
      <div className="pan_card_container">
        ...
        <div className="input_container">
          <input
            type="text"
            placeholder="Enter the PAN Card No"
            className="input_pan"
        ...
        {isVerified !== null &&
          (isVerified ? (
            <span className="pan_successful">PAN verified successfully</span>
          ) : (
            <span className="pan_failed">PAN verification failed</span>
          ))}

        {isVerified && (
          <button className="Pan_next_btn" onClick={handlenextBtn}>
            Next
          </button>
        )}
      </div>
